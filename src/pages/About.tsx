                ...
                {timeline.map((item, index) => (
                  <div key={index} className="relative text-center group">
                    ...
                    <div className="mt-8 px-2">
                      ...
                      <h3 className="font-script text-4xl md:text-5xl text-foreground mt-2 mb-3 transition-colors group-hover:text-violet-600">
                        {item.title}
                      </h3>
                ...
                {timeline.map((item, index) => (
                  <div key={index} className="relative group">
                    ...
                    <div>
                      ...
                      <h3 className="font-script text-4xl text-foreground mt-1 mb-2">
                        {item.title}
                      </h3>
                      <p className="text-sm text-muted-foreground leading-relaxed">
                        {item.description}
